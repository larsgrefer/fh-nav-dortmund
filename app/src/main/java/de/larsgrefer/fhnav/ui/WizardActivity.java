...
public class WizardActivity extends InjectionActionBarActivity implements Runnable {
		...
		public void handleMessage(Message msg) {
			if (handle1) {
				if (spinnerContent.size() < 1) {
					...
					final Dialog error_dialog = new Dialog(WizardActivity.this);
					...
					btn.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							loadSpinner = true;
							dialog = ProgressDialog.show(WizardActivity.this, "",
									"Download...", true);
							Thread t1 = new Thread(WizardActivity.this);
							t1.start();
						}
					});
					...
					spinner1 = (Spinner) WizardActivity.this
	...
	public void new_blank_plan() {
		...
		startActivity(new Intent(WizardActivity.this, MenuActivity.class));
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Best�tigungsbutton => Laden des Stundenplans...
		...
		btn.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				if (spinnerContent.size() >= 1) {
					...
					dialog = ProgressDialog.show(WizardActivity.this, "",
							"Download...", true);
					Thread t = new Thread(WizardActivity.this);
					t.start();
				}
			}
		});
		...
		btn1.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				loadSpinner = true;
				dialog = ProgressDialog.show(WizardActivity.this, "", "Download...",
						true);
				Thread t1 = new Thread(WizardActivity.this);
				t1.start();
			}
	...
	public void run() {
		if (!loadSpinner) {
			...
			// T1 Liste der Stundenpl�ne downloaden und bei => H1 in Spinner
			// packen
			try {
