...
import de.larsgrefer.fhnav.controller.PHPConnector;
import de.larsgrefer.fhnav.controller.Tools;
import de.larsgrefer.fhnav.ui.helper.ExtendedListAdapter;
import de.larsgrefer.fhnav.ui.helper.SeparatedListAdapter;
import de.larsgrefer.fhnav.model.Stundenplan;
...
public class AddVorlesungActivity extends InjectionActionBarActivity implements Runnable {
		...
		public void handleMessage(Message msg) {
			...
			if (!loadSpinner) {
				...
				if (spinnerContent.size() < 1) {
					...
					final Dialog error_dialog = new Dialog(AddVorlesungActivity.this);
					...
					btn.setOnClickListener(new OnClickListener() {
						...
						public void onClick(View v) {
							...
							loadSpinner = true;
							dialog = ProgressDialog.show(AddVorlesungActivity.this, "",
									"Download...", true);
							Thread t1 = new Thread(AddVorlesungActivity.this);
							t1.start();
						}
					});
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		click = false;
		spinner1 = (Spinner) AddVorlesungActivity.this.findViewById(R.id.Spinner01);
				...
				if ((spinnerContent.size() >= 1)
					...
					if (spinnerContent.get(0).equals(
						...
						if (selectedBranch != getString(R.string.addvorlesung_spinner_text)) {
							...
							dialog = ProgressDialog.show(AddVorlesungActivity.this, "",
									"Download...", true);
							Thread t = new Thread(AddVorlesungActivity.this);
							t.start();
						}
	...
	public void run() {
		try {
			if (!loadSpinner) {
				...
				spinnerContent.add("Studiengang w�hlen");
