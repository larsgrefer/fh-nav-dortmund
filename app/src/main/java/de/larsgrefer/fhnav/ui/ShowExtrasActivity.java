...
import de.larsgrefer.fhnav.ui.helper.NormalListAdapterForMenu;
import de.larsgrefer.fhnav.ui.helper.SeparatedListAdapter;
import de.larsgrefer.fhnav.model.CanteenMenu;
		...
		if (mensa) {
			...
			sp.setOnItemSelectedListener(new OnItemSelectedListener() {
				public void onItemSelected(AdapterView<?> arg0, View arg1,
					...
					// "Download...", true);
					Thread t1 = new Thread(ShowExtrasActivity.this);
					t1.start();
	...
	private void refreshButtons() {
		...
		btn2.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				startActivity(new Intent(ShowExtrasActivity.this, NavigationActivity.class));
			}
		});
