...
public class CalendarAdapter {
	...
	/**
	 * F�gt ein wiederkehrendes Ereignis in den Android Kalender ein
	 * 
	 * @param ver
	 *            Die Veranstaltung, die eingef�gt werden soll
	 * @param start
	 *            Startdatum f�r die Veranstaltungsfolge
	 * @param end
	 *            Enddatum f�r die Veranstaltungsfolge
	 */
