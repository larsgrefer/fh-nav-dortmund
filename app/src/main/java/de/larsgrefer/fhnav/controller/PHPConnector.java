package de.larsgrefer.fhnav.controller;
...
public class PHPConnector {
	...
	/**
	 * Generiert eine Liste mit allen Stundenpl�nen
	 * 
	 * @return Liste mit allen Stundenpl�nen
	 */
	 ...
	 * Parametern auf und parst die R�ckgabe in ein JSONArray
	 * 
	 * @param nvp
	 *            Gibt im Endeffekt an welche mysql-db anfrage ausgef�hrt werden
	 *            soll. (liegen in der php datei) Dies findet �ber einfach Get
